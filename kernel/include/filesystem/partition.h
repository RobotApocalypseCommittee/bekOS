...
public:
    ...
    TransferResult schedule_read(uSize byte_offset, bek::mut_buffer buffer, TransferCallback cb) override;
    TransferResult schedule_write(uSize byte_offset, bek::buffer buffer, TransferCallback cb) override;
