...
public:
    ...
    expected<bek::shared_ptr<mem::BackingRegion>> get_shareable_region(mem::UserRegion user_region);
    expected<MemoryOperation> get_allowed_operations(mem::UserRegion region);
